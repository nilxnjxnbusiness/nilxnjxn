        ...
        <div className="space-y-6">
          ...
          <form onSubmit={handleSubscribe} className="group relative">
            ...
            <button
              ...
              className="absolute top-1/2 right-2 -translate-y-1/2 flex min-w-[50px] items-center justify-center rounded-full bg-white px-4 py-1.5 text-[9px] font-bold tracking-widest text-black uppercase transition-all hover:scale-105 disabled:scale-100 disabled:opacity-50"
            >
              {isLoading ? (
                <svg className="h-3 w-3 animate-spin text-black" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24">
